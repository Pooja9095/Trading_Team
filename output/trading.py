...
class TradingAccount:
    ...
    def buy(self, symbol: str, quantity: int) -> float:
        ...
        if symbol in self.positions:
            ...
            total_cost_val = (position.shares * position.avg_cost) + (quantity * price)
            position.shares = total_shares
            position.avg_cost = total_cost_val / total_shares
        else:
            # Create new position
    ...
    def positions(self) -> List[Dict]:
        ...
        Returns:
            ...
            Each position contains 'symbol', 'shares', and 'avg_cost'
        """
        return [
            {
                "symbol": symbol,
